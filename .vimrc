...
map sl :set spl yitright<CR>:vsplit<CR>
...
map mds :MarkdownPreviewStop<CR>
...
map <LEADER>hi :UndotreeToggle<CR>
...
"设置文件目录
let g:UltiSnipsSnippetDirectories=["/Users/wetabq/ultisnips", "UltiSnips"]
"设置打开配置文件时为垂直打开
let g:UltiSnipsEditSplit="vertical"
"Snazzy Transparent Option
let g:SnazzyTransparent = 1
"SNazzy Lightline Option
let g:lightline = {
\ 'colorscheme': 'snazzy',
\ }
